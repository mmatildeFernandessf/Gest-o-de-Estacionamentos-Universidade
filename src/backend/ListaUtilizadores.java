...
public class ListaUtilizadores implements Serializable {
    ...
    public ArrayList<Seguranca> getSegurancas() {
        ...
        for (int i = 0; i < listaUtilizador.size(); i++) {
            Utilizador u = listaUtilizador.get(i);
            if (u instanceof Seguranca) {   //estamos a verificar se o objeto u que criámos é uma instancia da classe (seguranca)
    ...
    public ArrayList<Administrador> getAdministradores() {
        ...
        for (int i = 0; i < listaUtilizador.size(); i++) {
            Utilizador u = listaUtilizador.get(i);
            if (u instanceof Administrador) {     //estamos a verificar se o objeto u que criámos é uma instancia da classe (administrador)
