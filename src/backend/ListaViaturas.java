...
public class ListaViaturas implements Serializable {
    ...
    //Método para calcular a percentagem de viaturas por combustivel 
    /*  public double viaturasPorCombustivel(String combustivel) {
        double contador = 0;
        for (Viatura viatura : listaViaturas) {     //for-each usado para iterar sobre o arrayList listaViaturas
